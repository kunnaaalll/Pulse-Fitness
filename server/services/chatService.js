  ...
  try {
    ...
    if (!setting && process.env.PERPLEXITY_API_KEY) {
      ...
      return {
        ...
        custom_url: '',
        model_name: 'sonar-pro', // Default Perplexity model
    ...
    return setting; // Returns null if no active setting found and no fallback
  } catch (error) {
...
`;
    ...
    switch (aiService.service_type) {
      ...
      case 'anthropic':
        // ... (Anthropic implementation unchanged) ...
      ...
      case 'google':
        // ... (Google implementation unchanged) ...
        const googleBody = {
